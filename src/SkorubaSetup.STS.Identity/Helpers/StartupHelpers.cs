...
using SkorubaSetup.STS.Identity.Configuration;
using SkorubaSetup.STS.Identity.Configuration.ApplicationParts;
using SkorubaSetup.STS.Identity.Configuration.Constants;
using SkorubaSetup.STS.Identity.Configuration.Interfaces;
using SkorubaSetup.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace SkorubaSetup.STS.Identity.Helpers
{
